...
<html>
    <head>
        ...
        <link href="fundo2.css" rel="stylesheet" type="text/css">
        <link href="<?php echo $estilo; ?>" rel="stylesheet" type="text/css">
        ...
        <script type="text/javascript">
            ...
            function inicia() {
                ...
                document.getElementById("exibefrase").innerHTML = 'Você está falando com <strong>Todos</strong>.';
            }
        ...
        <div align="center">
            ...
            <div align="center">
                <table width="95%" border="0" cellspacing="0" cellpadding="0">
                    <tr> 
                        <td colspan="3" class="borda" align="center">
                            <table width="100%" border="0" cellspacing="0" cellpadding="2" class="table" style="margin-bottom: 0px!important;">
                                <tr>
                                    <td  id="exibefrase">&nbsp;</td>
                                    <td width="57"><input value="Sair" class="btn btn-primary" onClick="sair()" /></td>
                                </tr>
                                <!--
                                <tr>
                                    <td colspan="2">
                                        <script type="text/javascript" >
                                            ...
                                            document.write("Chat iniciado em: " + day + myweekday + month + " - " + timeValue);
                    ...
                    <tr> 
                        <td width="98%" height="353" align="center" bgcolor="#FFFFFF" class="chat" onMouseOver="document.getElementById('rolagem').value = 0" onMouseOut="document.getElementById('rolagem').value = 1, rolar()">
                            <iframe src="ler.html" name="fler" width="98%" marginwidth="0" height="352" marginheight="0" scrolling="auto" frameborder="0"></iframe>
                        </td>
                        <td width="6">&nbsp;</td>
                        <td class="borda" valign="top">
                    ...
                    <tr> 
                        <td colspan="3" height="10">
                            <iframe src="" name="fupload" width="1" marginwidth="0" height="1" marginheight="0" scrolling="no" frameborder="0"></iframe>
                            <input type="hidden" id="salvafrase" value="Você está falando com Todos.">
                        </td>
                    </tr>
                    <tr> 
                            ...
                            <table width="733" border="0" cellpadding="0" cellspacing="1">
                                <tr> 
                                    <td height="46" colspan="2">  
                                        <table border="0" cellspacing="0" cellpadding="0" class="texto11">
                                            <tr> 
                                                <td width="107" height="26" align="center" id="exibenick"><strong><font color="#006699"><?php echo $nick; ?>
                                                        </font></strong> </td>
                                                <td width="186">
                                                    <select name="select" class="form-control" id="reservado" title="Selecione como deseja interagir com este usuário">
                                ...
                                <tr> 
                                    <td width="483" height="0"> 
                                        <textarea name="textarea" cols="85" class="formbranco" rows="3" id="mensagem"  onKeyPress="ContaCaracteres();
                                                if (event.keyCode === 13) {
                                                    VerificaMsg();
                                                }" onKeyDown="ContaCaracteres();" onKeyUp="ContaCaracteres();" onFocus="ContaCaracteres();" onChange="ContaCaracteres();" title="Digite sua mensagem"></textarea></td>
