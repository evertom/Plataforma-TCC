...
if ($tipo == 0) {
    ...
    if (count($result)) {
        ...
        echo "<script type='text/javascript'>alert('Para poder acessar o painel ADM voc \u00ea deve requisitar um professor para orienta\u00e7\u00e3o e formar um grupo de TCC, volte para tela principal e escolha seu orientador...');location.href='acesso-negado.php'</script>";
    }
} else if ($tipo == 1) {
