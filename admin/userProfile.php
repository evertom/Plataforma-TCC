                    ...
                    <div class="row">
                        <div class="col-xs-12 col-sm-6 col-md-8">
                            <form method="post" class="reply" id="contact">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                            <div class="form-group input-group">
                                                ...
                                                <input id="name" name="name" type="text" placeholder="Nome" value="<?php echo $nome_user; ?>" required class="form-control" />
                                            </div>
                                        </div>
                                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                            <div class="form-group input-group">
                                                <span class="input-group-addon"><i class="fa fa-envelope"></i></span>
                                                <input class="form-control" type="email" id="email" name="email" placeholder="Email" value="<?php echo $email_users; ?>" required />
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                            <div class="form-group input-group">
                                                ...
                                                <input class="form-control" id="pass" name="pass" type="password"  placeholder="Senha" value="" required />
                                            </div>
                                        </div>
                                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                            <div class="form-group input-group">
                                                <span class="input-group-addon"><i class="fa fa-key"></i></span>
                                                <input class="form-control" id="prontuario" name="prontuario" type="text"  placeholder="Prontu&aacute;rio" value="<?php echo $prontuario_users; ?>" required />
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                            <div class="form-group input-group">
                                                ...
                                                if ($tipo_users == 0) {
                                                    $cargo_users = "Aluno";
                                                    echo '<input class="form-control" id="cargo" name="cargo" type="text"  placeholder="Cargo" value="' . $cargo_users . '" readonly="true" required />';
                                                } else {
                                                    echo '<input class="form-control" id="cargo" name="cargo" type="text"  placeholder="Cargo" value="' . $cargo_users . '" required />';
                                                }
                                                ?>
                                        ...
                                        <div class="col-lg-6">
                                            <div class="form-group input-group">
                                                ...
                                                <input class="form-control" id="nick" name="nick" type="text"  placeholder="Apelido" value="<?php echo $nick_users; ?>" required />
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <br/>
                                <input id="id_users" name="id_users" type="hidden" value="<?php echo $id_users; ?>" />
