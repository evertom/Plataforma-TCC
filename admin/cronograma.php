					...
					<div class="col-xs-4 col-sm-4 col-md-4">
						<form id="cronograma">
							<div class="form-group input-group">
								<select name="idTipoEvento" id="idTipoEvento" class="selectpicker" multiple  data-max-options="1" data-min-options="1" required data-style="btn-info"
								title='Qual é o tipo de evento?' data-live-search="true" >
							...
							<div class="form-group input-group">
								<select name="idParticipantes[]" id="idParticipantes" class="selectpicker" multiple  data-max-options="5" data-min-options="1" required data-style="btn-info"
								title='De quem é a tarefa?' data-live-search="true" data-selected-text-format="count>2" >
									<?php
										$pdo = new Conexao();
										$sql = "SELECT b.uid, b.username FROM grupo_has_users a ";
										$sql .= "INNER JOIN users b ON a.uid = b.uid WHERE a.idgrupo = $idgrupo ORDER BY b.username";
