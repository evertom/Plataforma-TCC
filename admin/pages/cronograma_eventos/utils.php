...
class Event {
	...
	public function __construct($array, $timezone=null) {
		...
		$this->textColor = $array['textColor'];
		$this->nomeEvento = $array['nomeEvento'];
		$this->descricao = $array['descricao'];
		$this->participantes = $array['participantes'];
		$this->concluido = $array['concluido'];
		$this->idGrupo = $array['idGrupo'];
		$this->idcronograma = $array['idcronograma'];
		$this->idTipoEvento = $array['idTipoEvento'];
