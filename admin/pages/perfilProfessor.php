<!-- Page Content -->
        <div id="page-wrapper">
			...
			<div class="row">
				<?php 
					$result = $pdo->select("SELECT u.username, u.fotouser, u.email, u.prontuario FROM users u INNER JOIN grupo_has_users gu ON gu.uid = u.uid INNER JOIN grupo g ON g.idgrupo = gu.idgrupo WHERE g.aceito = 1 AND g.visto = 1 AND g.idgrupo IN (".$condicao.") AND gu.tipo in(1,2) ");
						...
						if(count($result)){
							...
							echo '<div class="alert alert-danger alert-dismissable">
								...
								Voc&ecirc; ainda n&atilde;o possui grupos em que esteja orientando, verifique em suas notifica&ccedil;&otilde;es se h&agrave; pend&ecirc;ncias para acertar...
							</div>';
						}
				?>
			</div>
