...
<!-- Page Content -->
        <div id="page-wrapper">
			<?php
				...
				$result = $pdo->select("SELECT g.fraselema FROM users u INNER JOIN grupo_has_users gu ON gu.uid = u.uid INNER JOIN grupo g ON g.idgrupo = gu.idgrupo WHERE g.aceito = 1 AND g.visto = 1 AND g.idgrupo = ".$idGrupo." and u.uid = ".$id_users."");
				
				foreach($result as $res){
					$fraseLema = isset($res['fraselema']) ? $res['fraselema']:"Voc&ecirc; ainda n&atilde;o possui uma frase lema, v&aacute; ao painel de configura&ccedil;&otilde;es e cadastre sua frase que est&aacute; na monografia para exibila.";
				}
			?>
            <div class="container-fluid">
                <div class="row">
					...
					<div style="font-size:11px;"id="col-xs-6 col-md-4">
