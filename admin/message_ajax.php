    ...
    if (isset($data)) {
        ...
        <div class="stbody" id="stbody<?php echo $msg_id; ?>">
            ...
            <div class="sttext">
                ...
                <div style="float:right;" class="btn-group">
                    ...
                    <ul style="margin-left:-164px!important;margin-top:-25px!important;"class="dropdown-menu" role="menu">
                        <li><a class="EditarPostBt" onclick="EditarPostBt(this)"><i class="fa fa-edit"></i> Editar</a></li>
                        <li><a class="stdelete" onclick="stdelete(this)" id="<?php echo $msg_id; ?>" title="Delete update"><i class="fa fa-trash-o"></i> Excluir</a></li>
                    </ul>
                </div>
                <div class="sttime">
            ...
            <div class="boxPost">
                ...
                <div class="sttime">
                    <i class='fa fa-thumbs-o-up'></i> Curtir | <a onclick="commentopen(this)" class='commentopen' id='<?php echo $msg_id; ?>' title='Comment'><i class='fa fa-comments-o'></i> Comentar </a>
                </div>
                <div id="stexpandbox">
                    <div id="stexpand"></div>
                </div>
                ...
                <div class="commentupdate" style='display:none' id='commentbox<?php echo $msg_id; ?>'>
                    ...
                    <div class="stcommenttext" >
                        <form method="post" action="">
                            ...
                            <br/>
                            <input type="button"  value=" Comentar "  id="<?php echo $msg_id; ?>" class="comment_button btn btn-primary btn-xs" onclick="comment_button(this)"></input>
                        </form>
                    </div>
                </div>
            </div>
