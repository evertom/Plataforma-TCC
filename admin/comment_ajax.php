            ...
            <div class="stcommenttext" id="<?php echo $com_id; ?>">
                <div style="float:right;" class="btn-group">
                    ...
                    <ul style="margin-left:-164px!important;margin-top:-25px!important;"class="dropdown-menu" role="menu">
                        ...
                        <li><a class="stcommentdelete" onclick="stcommentdelete(this)" id="<?php echo $com_id; ?>" title="Delete Comment"><i class="fa fa-trash-o"></i> Excluir</a></li>	
                    </ul>
                </div>
                ...
                <a class="like stcommenttime curtirComments" onclick="curtirComments(this)"><i class='fa fa-thumbs-o-up'></i> Curtir</a>
                <div class='commentThis' style="display: inline;"></div>
            </div>
        </div>
        <?php
    }
