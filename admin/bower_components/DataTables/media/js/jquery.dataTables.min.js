...
iStateDuration:7200,iDeferLoading:null,iDisplayLength:10,iDisplayStart:0,iTabIndex:0,oClasses:{},oLanguage:{oAria:{sSortAscending:": activate de sort column ascending",sSortDescending:": activate de sort column descending"},oPaginate:{sFirst:"Primeiro",sLast:"Último",sNext:"Próximo",sPrevious:"Voltar"},sEmptyTable:"Não há dados a serem exibidos...",sInfo:"Mostrando _START_ de _END_ de _TOTAL_ entradas",sInfoEmpty:"Mostrando 0 de 0 de 0 entradas",sInfoFiltered:"(Foram encontrados _MAX_ entradas)",sInfoPostFix:"",sDecimal:"",
sThousands:",",sLengthMenu:"Mostrar _MENU_ entradas",sLoadingRecords:"Loading...",sProcessing:"Processing...",sSearch:"Procurar:",sSearchPlaceholder:"",sUrl:"",sZeroRecords:"Não foi encontrado nenhum resultado..."},oSearch:g.extend({},p.models.oSearch),sAjaxDataProp:"data",sAjaxSource:null,sDom:"lfrtip",searchDelay:null,sPaginationType:"simple_numbers",sScrollX:"",sScrollXInner:"",sScrollY:"",sServerMethod:"GET",renderer:null};V(p.defaults);p.defaults.column={aDataSort:null,iDataSort:-1,asSorting:["asc","desc"],bSearchable:!0,
