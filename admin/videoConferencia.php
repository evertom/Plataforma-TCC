...
<head>
    ...
    <!-- Alert Msg -->
    <link href="bootstrap3-dialog-master/dist/css/bootstrap-dialog.min.css" rel="stylesheet" type="text/css"/>
    <script src="bootstrap3-dialog-master/dist/js/bootstrap-dialog.min.js"></script>
...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-xs-12">
                        <h2 class="page-header">Vídeo <span class="text-danger">Conferência</span></h2>
                        <blockquote>
                            Aqui você pode falar ao vivo com os integrantes do seu grupo
                        </blockquote>
                        ...
                        <div>
                          <button id="startButton">Chamar</button>
                          <button id="callButton">Responder</button>
    ...
    <link href="WebRTC/css/main.css" rel="stylesheet"/>
    <script type="text/javascript" src="WebRTC/adapter.js"></script>
    <script type="text/javascript" src="WebRTC/main.js"></script>
