...
<html lang="en">
    <head>
        ...
        <script>
            ...
            function lineChart() {
                $.getJSON('ajax/graficoWorkflowJson.php', {idGrupo: $("#idgrupo").val()}, function(data){
                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-xs-12">
                            ...
                            <span class="text-danger">de acompanhamento do Fluxo do Trabalho</span></h2>
