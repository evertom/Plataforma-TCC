...
if($idProf == "" || $nomeProf == ""){
	$alerta = '<div class="alert alert-danger alert-dismissable">
							...
							Para requisitar um professor voc&ecirc; deve escolher um na tela principal do f&oacute;rum <a href="index.php" class="alert-link">Clique aqui</a>.
						</div>';
}else{
	$alerta = '<div class="alert alert-danger alert-dismissable">
							<button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
							<span class="glyphicon glyphicon-exclamation-sign" aria-hidden="true"></span>
							Preencha todos os campos, e descreva muito bem sua ideia para que o professor entenda sua proposta e possa aceita-la...
						</div>';
}
?>
<!DOCTYPE html>
...
<head>
	...
	<script>
		...
		load_dados(null, 'ajax/pesqAluno1.php', '#Pront1');
			...
			//Aqui uso o evento key up para começar a pesquisar, se valor for maior q 2 ele faz a pesquisa
